...
# df = pd.read_csv('C://Users//Taewon//Desktop//total_disease.csv', engine='python')
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small" placeholder="다른 증상을 입력해주세요" aria-label="Search" aria-describedby="basic-addon2">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">알고 싶은 배너를 클릭해주세요</h1>
          </div>
          ...
          <div class="row">
            ...
            <div OnClick="location.href ='banner2.py'" style="cursor:pointer;" class="col-xl-3 col-md-6 mb-4" id='banner2'>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">정의</h6>
                ...
                <!-- Card Body -->
                <div class="card-body" id='definition'>
                  {}
                </div>
              </div>
            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">원인</h6>
                  <div class="dropdown no-arrow">
                    <!-- <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">이거 이용
                    </a> -->
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink"></div>
